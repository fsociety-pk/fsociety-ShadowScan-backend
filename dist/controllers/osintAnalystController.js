...
exports.analyzeOsintData = void 0;
...
// ─── Main Controller ──────────────────────────────────────────────────────────
const analyzeOsintData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        ...
        // Log activity
        try {
            yield (0, logActivity_1.logUserActivityDirect)((_a = req.user) === null || _a === void 0 ? void 0 : _a.id, 'intelligence_report_generated', {
                reportId,
...
exports.analyzeOsintData = analyzeOsintData;
